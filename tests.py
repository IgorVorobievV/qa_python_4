...
class TestBooksCollector:
    ...
    def test_add_new_book_add_two_books_list_two_books(self):
    ...
    def test_add_new_book_add_same_books_no_duplicates_books(self):
        collector = BooksCollector()
    ...
    def test_add_new_book_incorrect_name_no_addition(self, name):
        collector = BooksCollector()
    ...
    def test_set_book_genre_add_genre_genre_added(self):
        collector = BooksCollector()
    ...
    def test_set_book_genre_add_missing_genre_no_genre(self):
        collector = BooksCollector()
    ...
    def test_get_book_genre_book_without_genre_no_genre(self):
        collector = BooksCollector()
    ...
    def test_get_books_with_specific_genre_available_genre_get_books(self):
        collector = BooksCollector()
    ...
    def test_get_books_with_specific_invalid_genre_no_books(self, genre):
        collector = BooksCollector()
    ...
    def test_get_books_for_children_available_genre_get_books(self):
        collector = BooksCollector()
    ...
    def test_get_books_for_children_missing_genre_no_books(self):
        collector = BooksCollector()
    ...
    def test_add_book_in_favorites_add_two_favorites_favorites_added(self):
        collector = BooksCollector()
    ...
    def test_delete_book_from_favorites_delete_favorite_no_favorite(self):
        collector = BooksCollector()
